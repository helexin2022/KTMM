...
var1=tk.StringVar()
l1=tk.Label(window,textvariable=var1,bg="white",font=("Arial",12),width=15,height=2)
l1.place(x=300,y=20)

var2=tk.StringVar()
l2=tk.Label(window,textvariable=var2,bg="white",font=("Arial",12),width=15,height=2)
l2.place(x=300,y=120)

var3=tk.StringVar()
l3=tk.Label(window,textvariable=var3,bg="white",font=("Arial",12),width=15,height=2)
l3.place(x=300,y=220)

var4=tk.StringVar()
l4=tk.Label(window,textvariable=var4,bg="white",font=("Arial",12),width=15,height=2)
l4.place(x=300,y=320)

var5=tk.StringVar()
l5=tk.Label(window,textvariable=var5,bg="white",font=("Arial",12),width=15,height=2)
l5.place(x=300,y=420)

on_hit1=False
b1 = tk.Button(window,text="Модель", width=15, height=2,command=hit_me1)
b1.place(x = 100,y = 20)
